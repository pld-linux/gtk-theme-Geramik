...
License:        GPL v2
Group:          Themes/Gtk
Source0:	http://www.kde-look.org/content/files/3952-%{_theme}-0.18.tar.gz
BuildRequires:  gtk+
BuildRequires:  gtk+2
...
Summary(pl):    Temat dla Gtk - Geramik - pliki wspólne
Group:          Themes/Gtk
...
Motyw dla GTK, maj±cy na celu nadanie aplikacjom GTK wygl±du podobnego
do stylu Keramik dla KDE.
Ten pakiet zawiera temat dla aplikacji opartych na gtk+.
...
Motyw dla GTK, maj±cy na celu nadanie aplikacjom GTK wygl±du podobnego
do stylu Keramik dla KDE.
Ten pakiet zawiera temat dla aplikacji opartych na gtk+2.
